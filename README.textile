...
# git clone git://github.com/copernic67/rss2tumblr.git
...
Developped by lejoe ( http://lejoe.com )
Based on chregu's rss2twi.php and reused thanks to his permissive license.
